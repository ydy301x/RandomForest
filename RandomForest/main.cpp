...
int main(int argc, const char * argv[])
{
	...
	readData(trainset, trainlabels, "londontdataset.csv", "train-labels-idx1-ubyte");
	
	readData2(testset, testlabels, "testdata.csv");
...
//		"/Users/xinling/PycharmProjects/MNIST_data/t10k-labels-idx1-ubyte");
    ...
    randomForest.train(trainset,trainlabels,TRAIN_NUM,FEATURE, NUMBER_OF_CLASSES,false);
